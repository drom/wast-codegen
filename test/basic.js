...
describe('basic', function () {
  ...
  it('test import', function (done) {
    ...
    expect(lib.generate(json)).to.eq('(module (import $print_i32 "spectest" "print"(param i32)))')
    done()
  })

  it.only('test export', function (done) {
    const json = {
      'kind': 'script',
      'body': [{
        'kind': 'module',
    ...
    expect(lib.generate(json)).to.eq('(module (func ) (export "test" 0))')
    done()
  })
})
